...
CAMERA_SENSOR_OFFSET=${CAMERA_SENSOR_OFFSET:-"[0.01,0.01,0.44]"}
CAMERA_MOUNT_QUAT=${CAMERA_MOUNT_QUAT:-"[0.00644801,0.23350163,0.00644801,0.97231365]"}
...
if [[ -n "${TERRAIN_OBJ}" && ! -f "${TERRAIN_OBJ}" ]]; then
