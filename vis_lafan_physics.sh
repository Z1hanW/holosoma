...
# Physics rollout with Viser for LAFAN-trained MLP (flat terrain by default).
#
# Required:
...
#   GEOMETRY_DIR=/abs/path/to/obj_dir_or_obj_file   # optional (omit for flat)
#   GEOMETRY_META=/abs/path/to/metadata.json        # optional
#   NUM_ROWS=1
#   NUM_COLS=
