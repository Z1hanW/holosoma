...
#   bash infer_terrain_track.sh terrain [checkpoint] [motion] [geometry] [extra args...]
#   bash infer_terrain_track.sh obj <checkpoint> <motion_dir_or_file> <object_urdf> [extra args...]
#
...
usage() {
  cat <<'EOF'
Usage:
  bash infer_terrain_track.sh [checkpoint.pt|wandb://...|https://wandb.ai/.../runs/...] [motion_dir_or_file] [geometry_obj_or_dir] [extra tyro args...]
  bash infer_terrain_track.sh terrain [checkpoint.pt|wandb://...|https://wandb.ai/.../runs/...] [motion_dir_or_file] [geometry_obj_or_dir] [extra tyro args...]
