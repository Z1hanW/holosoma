...
case "$(echo "${AS_AUTO_FORWARD_AFTER_LIFT:-0}" | tr '[:upper:]' '[:lower:]')" in
  1|true|yes|on)
    AUTO_FORWARD_LOG_TS="$(date +%Y%m%d_%H%M%S)"
    mkdir -p "${SCRIPT_DIR}/logs/runtime"
    export VISER_AUTO_FORWARD_AFTER_LIFT=1
    export VISER_AUTO_FORWARD_AFTER_LIFT_COMMAND="${VISER_AUTO_FORWARD_AFTER_LIFT_COMMAND:-${AS_AUTO_FORWARD_AFTER_LIFT_COMMAND:-0.5,0,0}}"
    export VISER_AUTO_FORWARD_AFTER_LIFT_REL_Z_DELTA="${VISER_AUTO_FORWARD_AFTER_LIFT_REL_Z_DELTA:-${AS_AUTO_FORWARD_AFTER_LIFT_REL_Z_DELTA:-0.10}}"
    export VISER_AUTO_FORWARD_AFTER_LIFT_CONSECUTIVE_STEPS="${VISER_AUTO_FORWARD_AFTER_LIFT_CONSECUTIVE_STEPS:-${AS_AUTO_FORWARD_AFTER_LIFT_CONSECUTIVE_STEPS:-5}}"
    export VISER_AUTO_FORWARD_AFTER_LIFT_DURATION_S="${VISER_AUTO_FORWARD_AFTER_LIFT_DURATION_S:-${AS_AUTO_FORWARD_AFTER_LIFT_DURATION_S:-8.0}}"
    export VISER_AUTO_FORWARD_AFTER_LIFT_LOG_HZ="${VISER_AUTO_FORWARD_AFTER_LIFT_LOG_HZ:-${AS_AUTO_FORWARD_AFTER_LIFT_LOG_HZ:-20}}"
    export VISER_AUTO_FORWARD_AFTER_LIFT_LOG_PATH="${VISER_AUTO_FORWARD_AFTER_LIFT_LOG_PATH:-${SCRIPT_DIR}/logs/runtime/infer_as_auto_forward_after_lift_${AUTO_FORWARD_LOG_TS}.jsonl}"
    ;;
esac
...
if [[ "${VISER_AUTO_FORWARD_AFTER_LIFT:-0}" == "1" ]]; then
  echo "[INFO] auto_forward_after_lift=1 command=${VISER_AUTO_FORWARD_AFTER_LIFT_COMMAND} rel_z_delta=${VISER_AUTO_FORWARD_AFTER_LIFT_REL_Z_DELTA} duration_s=${VISER_AUTO_FORWARD_AFTER_LIFT_DURATION_S}"
  echo "[INFO] auto_forward_after_lift_log=${VISER_AUTO_FORWARD_AFTER_LIFT_LOG_PATH}"
fi
