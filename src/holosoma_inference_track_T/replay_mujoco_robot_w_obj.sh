...
POSE_LOG=${POSE_LOG:-"logs/replay_motion_mujoco/robot_w_obj_pose_${TS}.csv"}
...
echo "[replay_mujoco_robot_w_obj] motion=${MOTION_FILE}"
echo "[replay_mujoco_robot_w_obj] object_urdf=${OBJECT_URDF}"
echo "[replay_mujoco_robot_w_obj] pose_log=${POSE_LOG}"
"${cmd[@]}"
