...
from holosoma.utils.common import validate_deterministic_runtime, validate_numpy_seed
...
def set_seed(seed: int, torch_deterministic: bool = False) -> int:
    ...
    """
    # Reject a missing CUDA determinism prerequisite before even the legacy
    # ``seed == -1`` branch is allowed to draw from NumPy.
