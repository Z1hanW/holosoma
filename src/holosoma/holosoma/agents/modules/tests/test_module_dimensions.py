...
def test_distill_critic_obs_keeps_single_frame_state_and_proprio_history():
    ...
    removed_terms = {
        ...
        "left_palm_contact_prior_occupancy",
        "right_palm_contact_prior_occupancy",
        "arm_contact_prior_occupancy",
        "torso_contact_prior_occupancy",
        "left_palm_contact_prior_force",
        "right_palm_contact_prior_force",
        "arm_contact_prior_force",
        "torso_contact_prior_force",
        "left_palm_contact_prior_pos_obj",
        "right_palm_contact_prior_pos_obj",
        "arm_contact_prior_pos_obj",
        "torso_contact_prior_pos_obj",
        "left_palm_object_contact_force",
        "right_palm_object_contact_force",
        "arm_object_contact_force",
        "torso_object_contact_force",
        "feet_object_contact_force",
        "ankle_object_contact_force",
        "left_palm_object_contact_flag",
        "right_palm_object_contact_flag",
        "arm_object_contact_flag",
