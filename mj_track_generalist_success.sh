...
Purpose:
  Run the object-generalist MuJoCo tracker on the same prepared legacy motion
  bank used by infer_box_tracking.sh.
...
export USE_TRAINING_OBJECT_CONTACT_MARKERS="${USE_TRAINING_OBJECT_CONTACT_MARKERS:-0}"
