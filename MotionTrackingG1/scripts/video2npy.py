...
name = "TigerWoods_0"
motion_filename =  f"motion_data/video_motion/{name}.npz"
motion_outpath = f"motion_data/{name}.npy"
# urdf_path = f'motion_tracking/data/assets/urdf/scene_parkour_{name}.urdf'
...
root_trans_offset = torch.from_numpy(motion_data["trans"])
...
if robot_cfg["upright_start"]:
    ...
    print(f"Saving to {motion_outpath}")
    new_sk_motion.to_file(str(motion_outpath))