...
class Visualizer3D:
    ...
    def init_scene(self, init_args):
        ...
        if self.use_floor:
            ...
            tex = pyvista.numpy_to_texture(
                make_checker_board_texture('#81C6EB', '#D4F1F7', width=1000, height=1000, n_tile=1))
            self.floor_actor = self.pl.add_mesh(self.floor_mesh, texture=tex, ambient=0.2, diffuse=0.8, specular=0.8,
        ...
        if self.add_cube:
            ...
            self.pl.add_mesh(self.cube_mesh, color='orange', ambient=0.2, diffuse=0.8, specular=0.8, specular_power=10,
                             smooth_shading=True)
    ...
    def show_animation(self, window_size=(800, 800), init_args=None, enable_shadow=None, frame_mode='fps', fps=30,
                       repeat=False, show_axes=True):
        self.interactive = True
    ...
    def save_animation_as_video(self, video_path, init_args=None, window_size=(800, 800), enable_shadow=None, fps=30,
                                crf=25, frame_dir=None, cleanup=True, no_vid=False, frame_prefix=''):
