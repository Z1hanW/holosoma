...
readonly SOURCE_ID=src-fa0be8d228aefac39e3f1fbd062c55997d9e3e886c3e88b76ef780ef7f312746
readonly SOURCE_DIGEST=fa0be8d228aefac39e3f1fbd062c55997d9e3e886c3e88b76ef780ef7f312746
readonly SOURCE_ROOT="/home/ubuntu/FAR/holosoma_runs/${SOURCE_ID}"
readonly RUN_ROOT=/home/ubuntu/FAR/holosoma_runs/formal_priv_teacher_rollout30_ws64_20260719_0635
readonly RUN_NAME=priv_teacher_rollout30_ws64_u8init_dynmatch_srcfix_20260719_071125
...
export HOLOSOMA_LAUNCH_TOKEN=ec6e13a1b365ca5ca0b80b61d29aa590e0af5d73ad47f143054146727c0cf07e
export HOLOSOMA_LAUNCH_EPOCH=1784445096

export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
export NPROC=8
export NNODES=8
export MASTER_ADDR=10.99.0.141
export MASTER_PORT=31641
...
export RANDOMIZATION_PRESET=g1_29dof_wbt_w_object_with_action_delay
...
cd "${SOURCE_ROOT}"
echo "[INFO] formal_teacher_worker_preflight_ok node_rank=${NODE_RANK} host=$(hostname) ip=${EXPECTED_NODE_IP} source=${SOURCE_ID} wandb=zihanw22/carry-any/toxsjobi"
