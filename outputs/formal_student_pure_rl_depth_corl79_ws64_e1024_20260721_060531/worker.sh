...
readonly LAUNCH_ROOT=/home/ubuntu/FAR/holosoma_runs/formal_student_pure_rl_depth_corl79_ws64_e1024_20260721_060531
readonly RUN_ROOT="${LAUNCH_ROOT}/run"
readonly RUN_NAME=student_pure_rl_depth_corl79_ws64_e1024_20260721_060531
readonly RUN_CONTRACT="${LAUNCH_ROOT}/run_contract.json"
readonly RUN_CONTRACT_SHA=86011f08b807f3f5c027060c0c3899d02d9922a423ff5dd1f7c49c151d46038c
readonly REPLAY_MANIFEST="${LAUNCH_ROOT}/replay_preflight_manifest.json"
readonly REPLAY_MANIFEST_SHA=bc8133f25922fb91ef076f64aa8d8b61f7a6571201b137cbcb9238439571e3fd
...
export HOLOSOMA_LAUNCH_TOKEN=fde14fd566b035982e76c8b7497909260a301cb32bd6e8e1a3816940fb17c25c
export HOLOSOMA_LAUNCH_EPOCH=1784614427795746308

export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
export NPROC=8
export NNODES=8
export MASTER_ADDR=10.99.0.24
export MASTER_PORT=31761
...
cd "${SOURCE_ROOT}"
echo "[INFO] formal_student_pure_rl_depth_ws64_preflight_ok node_rank=${NODE_RANK} host=$(hostname) ip=${EXPECTED_NODE_IP} source=${SOURCE_ID} wandb=zihanw22/carry-any/3m8lkcxf pure_ppo=true distill=false teacher_loaded=false depth_student=true fresh_policy=true"
