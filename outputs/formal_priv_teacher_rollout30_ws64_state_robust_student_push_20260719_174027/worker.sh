...
readonly RUN_ROOT=/home/ubuntu/FAR/holosoma_runs/formal_priv_teacher_rollout30_ws64_state_robust_student_push_20260719_174027
readonly RUN_NAME=priv_teacher_rollout30_ws64_state_robust_student_push_u8init_noreset_20260719_174027
readonly RANDOMIZATION_CONTRACT="${RUN_ROOT}/teacher_randomization_contract.json"
readonly RANDOMIZATION_CONTRACT_SHA=6601a161cf11bb3db89645199e4eddb544ba3a7645ba41c390db70eb3f0508d7
...
export HOLOSOMA_LAUNCH_TOKEN=c5414d946c518b506036b38e697fc296e7cc9bfa56abd0b46041048d34424e08
export HOLOSOMA_LAUNCH_EPOCH=1784483377

export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
export NPROC=8
export NNODES=8
export MASTER_ADDR=10.99.0.141
export MASTER_PORT=31661
...
cd "${SOURCE_ROOT}"
echo "[INFO] formal_teacher_worker_preflight_ok node_rank=${NODE_RANK} host=$(hostname) ip=${EXPECTED_NODE_IP} source=${SOURCE_ID} wandb=zihanw22/carry-any/li1gcc1v randomization=g1_29dof_wbt_w_object_teacher_state_robust push_matches_student=true checkpoint_reset=false"
