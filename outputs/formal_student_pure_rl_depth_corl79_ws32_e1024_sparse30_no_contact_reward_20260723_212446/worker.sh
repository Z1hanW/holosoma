...
readonly LAUNCH_ROOT=/home/ubuntu/FAR/holosoma_runs/formal_student_pure_rl_depth_corl79_ws32_e1024_sparse30_no_contact_reward_20260723_212446
readonly RUN_ROOT="${LAUNCH_ROOT}/run"
readonly RUN_NAME=student_pure_rl_depth_corl79_ws32_e1024_sparse30_no_contact_reward_20260723_212446
readonly RUN_CONTRACT="${LAUNCH_ROOT}/run_contract.json"
readonly RUN_CONTRACT_SHA=adafdd5710557d6d88feea99e7ca78b84e0a896f81b46cee54a8097dcc35851c
readonly REPLAY_MANIFEST="${LAUNCH_ROOT}/replay_preflight_manifest.json"
readonly REPLAY_MANIFEST_SHA=dd9426280315e1d8001b94a671c8ff2be6d1fb6bf553eb6060d99495f0fcf7de
...
check_sha 63d5bc1c5ebae2ae863728511fe4a0904e78b2edfa7f7b176c1683dcfdf6e954 "${SHARD_ROOT}/manifest.json"
...
export HOLOSOMA_LAUNCH_TOKEN=61595690f335f389b5fe44c73e012dd4e13195f60b99890a04675b7aef51d901
export HOLOSOMA_LAUNCH_EPOCH=1784842050658838383

export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
export NPROC=8
export NNODES=4
export MASTER_ADDR=10.99.0.141
export MASTER_PORT=31781
...
cd "${SOURCE_ROOT}"
echo "[INFO] formal_student_pure_rl_depth_sparse30_ws32_preflight_ok node_rank=${NODE_RANK} host=$(hostname) ip=${EXPECTED_NODE_IP} source=${SOURCE_ID} wandb=zihanw22/carry-any/4sp43zax pure_ppo=true distill=false teacher_loaded=false depth_student=true fresh_policy=true offline_contact_guidance_weight=0.0 sparse_root_mode=t1_aligned_segment sparse_root_segment_steps=30"
