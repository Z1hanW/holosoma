...
readonly LAUNCH_ROOT=/home/ubuntu/FAR/holosoma_runs/formal_student_pure_rl_depth_corl79_ws64_e1024_no_contact_reward_20260722_212804
readonly RUN_ROOT="${LAUNCH_ROOT}/run"
readonly RUN_NAME=student_pure_rl_depth_corl79_ws64_e1024_no_contact_reward_20260722_212804
readonly RUN_CONTRACT="${LAUNCH_ROOT}/run_contract.json"
readonly RUN_CONTRACT_SHA=f6a47fcf3e238685c3097e5fa84b4abd22f44d86aae2552cac25a9e144168c4b
readonly REPLAY_MANIFEST="${LAUNCH_ROOT}/replay_preflight_manifest.json"
readonly REPLAY_MANIFEST_SHA=64aa82241c0f4b4c66cf69208783e0301ca1c994c88a3889bcbd951bb827022a
...
readonly SHARD_ROOT="${SINGLE_DIR}/_rank_shards/by-source/21a783b2d776daff212deab32af8bb0c6811cd75ecb4f141e58421b338358e53/ws64"
...
check_sha 2378e682cf8906854050731bc45a340a157c61be9eaeefb24fe31ef14ed4f470 "${SHARD_ROOT}/manifest.json"
...
export HOLOSOMA_LAUNCH_TOKEN=750ba7dce6d22f41d051a4ba88c7b24d619353bae9714e23ee3a124d98ee4070
export HOLOSOMA_LAUNCH_EPOCH=1784755685363050960

export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
export NPROC=8
export NNODES=8
export MASTER_ADDR=10.99.0.24
export MASTER_PORT=31771
...
export HOLOSOMA_EXTERNAL_AS_RANK_SHARD_SOURCE_DIGEST=21a783b2d776daff212deab32af8bb0c6811cd75ecb4f141e58421b338358e53
...
cd "${SOURCE_ROOT}"
echo "[INFO] formal_student_pure_rl_depth_ws64_preflight_ok node_rank=${NODE_RANK} host=$(hostname) ip=${EXPECTED_NODE_IP} source=${SOURCE_ID} wandb=zihanw22/carry-any/34qv1qqp pure_ppo=true distill=false teacher_loaded=false depth_student=true fresh_policy=true offline_contact_guidance_weight=0.0"
