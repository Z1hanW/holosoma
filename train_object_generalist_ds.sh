...
REFERENCE_ROOT_POS_W=0.5
REFERENCE_ROOT_ORI_W=0.5
REFERENCE_FULL_BODY_POS_W=1.0
REFERENCE_FULL_BODY_ORI_W=1.0
REFERENCE_FULL_BODY_LIN_VEL_W=1.0
REFERENCE_FULL_BODY_ANG_VEL_W=1.0
REFERENCE_OBJECT_POS_W=1.0
REFERENCE_OBJECT_ORI_W=1.0
REFERENCE_ACTION_RATE_L2_W=-0.1
REFERENCE_ROOT_POS_SIGMA=0.3
REFERENCE_ROOT_ORI_SIGMA=0.4
REFERENCE_FULL_BODY_POS_SIGMA=0.3
REFERENCE_FULL_BODY_ORI_SIGMA=0.4
REFERENCE_FULL_BODY_LIN_VEL_SIGMA=1.0
REFERENCE_FULL_BODY_ANG_VEL_SIGMA=3.14
REFERENCE_OBJECT_POS_SIGMA=0.3
REFERENCE_OBJECT_ORI_SIGMA=0.4
...
train_cmd=(
  ...
  --reward.terms.action_rate_l2.weight="${ACTION_RATE_L2_W}"
