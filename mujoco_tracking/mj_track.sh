...
if obs_shape is not None and len(obs_shape) >= 2 and isinstance(obs_shape[1], int):
    obs_dim = obs_shape[1]
actor_obs_shape = input_dims.get("actor_obs")
if obs_dim is None and actor_obs_shape is not None and len(actor_obs_shape) >= 2 and isinstance(actor_obs_shape[1], int):
