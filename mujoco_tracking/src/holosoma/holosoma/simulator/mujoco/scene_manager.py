...
class MujocoSceneManager:
    ...
    def add_robot(
        ...
        if object_spec_to_attach is not None:
            ...
            object_body_name = self._object_body_name_by_name.get("object")
            if object_body_name:
                self._find_spec_body(self.world_spec, object_body_name).add_freejoint(name="object_freejoint")
    ...
    def _select_object_root_body_name(object_spec: mujoco.MjSpec) -> str:
        ...
        for body in object_spec.bodies:
            ...
            if name and name.lower() not in {"world", "universe"}:
                return name
