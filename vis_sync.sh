...
# Physics rollout with Viser synced to sim control frequency (VideoMimic-style).
#
# Required:
...
#   ENV_SPACING=0.0
#   PAIR_TERRAIN=True
#   DEPTH_IMPL=rendered|depth_sensor|raycast|scandots|none
...
VISER_UPDATE_HZ=${VISER_UPDATE_HZ:-0}
