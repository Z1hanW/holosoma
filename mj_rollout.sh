...
MODEL="$(python scripts/mj_resolve_wandb_model.py "${2:-$HOLOSOMA_MJ_MODEL}")"; PATCH_DIR="${PATCH_DIR:-logs/live_debug/mj_rollout}"; PATCHED="${PATCH_DIR}/$(basename "${MODEL%.onnx}")__${HOLOSOMA_MJ_CLIP}.onnx"
