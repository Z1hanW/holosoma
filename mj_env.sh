...
Examples:
  ...
  COMMAND_WEB_PORT=7777 VISER_PORT=2984 bash mj_env_mujoco_render_848.sh box_74
...
echo "[INFO] web_demo_object_contacts=${HOLOSOMA_MUJOCO_WEB_DEMO_OBJECT_CONTACTS} training_object_contact_pairs=${HOLOSOMA_MUJOCO_TRAINING_OBJECT_CONTACT_PAIRS} keep_reference_hand_collision=${HOLOSOMA_MUJOCO_KEEP_REFERENCE_HAND_COLLISION}"
