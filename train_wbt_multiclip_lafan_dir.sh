...
CUDA_VISIBLE_DEVICES=1,2,7 torchrun --nproc_per_node=3 --master_port=$((29500 + RANDOM % 1000)) src/holosoma/holosoma/train_agent.py \
  ...
  \
  --command.setup_terms.motion_command.params.motion_config.motion_file ../holosoma_lafan_npz/motion_bank.h5 \
  ...
  --logger.name="g1_videomimic_h5fix"
