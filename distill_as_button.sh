...
Useful env vars:
  ...
  RESUME_FROM_BOX=1             initialize from a box-button policy; default d9m3z369/model_12500.pt
...
if [[ "${RESUME_FROM_BOX}" == "1" ]]; then
  ...
  DEFAULT_BOX_RESUME_MODEL_FILE=${DEFAULT_BOX_RESUME_MODEL_FILE:-model_12500.pt}
...
if [[ "${AS_SUCCESS133_FINAL0P5:-0}" == "1" && "${RESUME_FROM_BOX:-0}" == "1" ]]; then
