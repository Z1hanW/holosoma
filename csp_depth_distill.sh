...
RUN_NAME="${RUN_NAME:-${HOSTNAME_SHORT}_g1_29dof_depth_student_${TRAINING_MODE}_${STUDENT_COMMAND_MODE}_distill_${DISTILL_TAG}_${NUM_GPUS}gpu_${ENVS_PER_GPU}env_${TIMESTAMP}}"
