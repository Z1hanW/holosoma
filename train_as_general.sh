...
if [[ "${OBJECT_SPAWN_MODE}" == "urdf" ]]; then
  ...
  export HOLOSOMA_FILTER_MOTION_BANK_BY_OBJECT_SHARD="${HOLOSOMA_FILTER_MOTION_BANK_BY_OBJECT_SHARD:-1}"
else
  export HOLOSOMA_SHARD_OBJECT_ASSETS_BY_RANK="${HOLOSOMA_SHARD_OBJECT_ASSETS_BY_RANK:-1}"
  export HOLOSOMA_FILTER_MOTION_BANK_BY_OBJECT_SHARD="${HOLOSOMA_FILTER_MOTION_BANK_BY_OBJECT_SHARD:-0}"
fi
...
echo "[INFO] HOLOSOMA_FILTER_MOTION_BANK_BY_OBJECT_SHARD=${HOLOSOMA_FILTER_MOTION_BANK_BY_OBJECT_SHARD}"
