...
export HOLOSOMA_MUJOCO_ALLOW_PERCEPTION_NOISE="${HOLOSOMA_MUJOCO_ALLOW_PERCEPTION_NOISE:-False}"
...
[ -z "${HOLOSOMA_MJ_OBJECT_MASS:-}" ] && { [ "$CLIP" = "box_75" ] && export HOLOSOMA_MJ_OBJECT_MASS=0.2 || export HOLOSOMA_MJ_OBJECT_MASS=1.0; }
