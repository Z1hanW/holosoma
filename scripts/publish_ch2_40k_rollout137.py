...
EVAL_ROOT = Path(
    ...
    "ch2ckwzw_model40000_batch137_native_20260908"
)
ORIGINAL_VIEW = Path(
    "/data/holosoma_worktrees/ch2ckwzw_batch_eval_dc1a1d8a/data/prism137_eval"
)
PUBLICATION_ROOT = Path(
    "/data/holosoma_inputs/"
    "ch2ckwzw_model40000_rollout137_20260908/by-source"
)
EXPECTED_CHECKPOINT = {
