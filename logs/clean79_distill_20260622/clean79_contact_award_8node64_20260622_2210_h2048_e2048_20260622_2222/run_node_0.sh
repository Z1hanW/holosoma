...
mkdir -p /home/ubuntu/FAR/holosoma/logs/clean79_distill_20260622/clean79_contact_award_8node64_20260622_2210_h2048_e2048_20260622_2222
...
export NNODES=8
export NODE_RANK=0
export MASTER_ADDR=10.99.1.60
export MASTER_PORT=29689
...
export NCCL_SOCKET_IFNAME=${NCCL_SOCKET_IFNAME:-enp135s0}
export GLOO_SOCKET_IFNAME=${GLOO_SOCKET_IFNAME:-enp135s0}
...
echo "[INFO][10.99.1.60] session=clean79_contact_award_8node64_20260622_2210_h2048_e2048 node_rank=0/8 nproc=8 per_gpu_envs=2048 total_envs=131072"
echo "[INFO][10.99.1.60] master=10.99.1.60:29689"
