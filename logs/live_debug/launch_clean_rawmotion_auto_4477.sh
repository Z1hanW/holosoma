...
export HOLOSOMA_W_OBJECT_URDF="g1/g1_29dof.urdf"
...
export MJ_ENV_RECORD_DURATION="${MJ_ENV_RECORD_DURATION:-60}"
export MJ_ENV_RECORD_SIM_DURATION="${MJ_ENV_RECORD_SIM_DURATION:-6.5}"
export MJ_ENV_RECORD_OUTPUT="${MJ_ENV_RECORD_OUTPUT:-/home/ubuntu/FAR/holosoma/logs/live_debug/${TAG}_mujoco_render_4477.mp4}"
export MJ_ENV_RECORD_SKIP_RESET="${MJ_ENV_RECORD_SKIP_RESET:-1}"
export MJ_ENV_RECORD_PRE_TRIGGER_WAIT_S="${MJ_ENV_RECORD_PRE_TRIGGER_WAIT_S:-18.0}"
...
export POLICY_DEFER_UNTIL_VALID_STATE="${POLICY_DEFER_UNTIL_VALID_STATE:-0}"
...
export HOLOSOMA_USE_MOTION_DATA_AS_Q_TARGET="0"
export HOLOSOMA_USE_MOTION_COMMAND_AS_Q_TARGET="0"
