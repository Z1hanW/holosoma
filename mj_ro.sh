...
if [[ -z "$inference_config" ]]; then
  case "$model_run_id" in
    36k1vwdf|zzv6vtkk)
      ...
      ;;
    a1lh8uxa|d9m3z369|gjiefd3c|qihvpyqg|swl41n4x|9ez2ivr4|34qv1qqp|6urn4jvc)
...
case "$model_run_id" in
  1j98x3g1|6c7exbeq|lk9ocrn6|kxnhgj2v|iepncc89|a1lh8uxa|d9m3z369|gjiefd3c|qihvpyqg|swl41n4x|9ez2ivr4|34qv1qqp|6urn4jvc|36k1vwdf|zzv6vtkk)
