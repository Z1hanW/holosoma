...
echo "[INFO] split_perception_noise edge=${PERCEPTION_CAMERA_WARP_EDGE_NOISE} holes=${PERCEPTION_CAMERA_WARP_ENABLE_HOLES} sensor=${PERCEPTION_CAMERA_APPLY_SENSOR_NOISE}"
